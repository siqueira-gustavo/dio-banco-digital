...
## # Criando uma APP de Banco Digital com Java e Orientação a Objetos

<!-- TOC -->

- [BOOTCAMP GFT QUALITY ASSURANCE #1 - DIGITAL INNOVATION ONE](#bootcamp-gft-quality-assurance-1---digital-innovation-one)
    - [# Criando uma APP de Banco Digital com Java e Orientação a Objetos](#-criando-uma-app-de-banco-digital-com-java-e-orienta%C3%A7%C3%A3o-a-objetos)
...
Criar uma tela que simula operações bancárias no terminal (console). Os dados serão perdidos após fechar o programa.
